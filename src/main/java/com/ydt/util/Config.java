...
public final class Config {
    ...
    static {
        try {
            ...
            props.load(new FileInputStream(path + "config-online.properties"));
        } catch (Exception e) {
            e.printStackTrace();
...
//    public static String getOption(List<S_dw> sDwList){
//        String options = "";
//        for (S_dw dw : sDwList){
//            options += "<option value='"+dw.getId()+"'>"+dw.getDwmc()+"</option>";
//        }
//        return options;
//    }
}
